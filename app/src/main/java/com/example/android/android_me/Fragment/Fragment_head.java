...
public class Fragment_head extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View vHead = inflater.inflate(R.layout.fragment_layout_head, container, false);

        final ImageView img = (ImageView) vHead.findViewById(R.id.imgHead);
        ...
        img.setImageResource(ImageAssets.getHeads().get(index));
