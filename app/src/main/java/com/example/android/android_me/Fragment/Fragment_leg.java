...
public class Fragment_leg extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View vHead = inflater.inflate(R.layout.fragment_layout_leg, container, false);

        final ImageView img = (ImageView) vHead.findViewById(R.id.imgLeg);
        ...
        img.setImageResource(ImageAssets.getLegs().get(index));
